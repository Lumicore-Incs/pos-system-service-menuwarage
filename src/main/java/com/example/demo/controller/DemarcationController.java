...
public class DemarcationController {
    ...
    @PostMapping()
    public ResponseEntity<Object> registerUser(@RequestBody DemarcationDto dto, @RequestHeader(name = "Authorization") String authorizationHeader) {
    ...
    public ResponseEntity<Object> searchUser(@PathVariable Long id, @RequestHeader(name = "Authorization") String authorizationHeader) {
        if (this.jwtTokenGenerator.validateJwtToken(authorizationHeader)) {
